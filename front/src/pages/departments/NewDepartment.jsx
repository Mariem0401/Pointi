    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Créer un nouveau département</h1>
            <p className="mt-1 text-sm text-gray-500">Remplissez les détails du département ci-dessous</p>
          </div>
          <button 
